...
const Quates = () => {
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-start p-10 bg-gray-50 gap-x-8 min-h-screen">
      ...
      <div className="w-full md:w-1/2 lg:max-w-xl bg-white p-8 rounded-lg shadow-lg">
